...
ImageButton1.Image = "http://www.roblox.com/asset/?id=115327581671218"
...
local LogoHub = Instance.new("ImageLabel")
    ...
    LogoHub.Image = "http://www.roblox.com/asset/?id="..tostring(115327581671218)
...
local LogoToggle = Instance.new("ImageLabel")
    ...
    LogoToggle.Image = "http://www.roblox.com/asset/?id="..tostring(115327581671218)
...
-- Tab
local D = Library:AddTab("Discord","6026568198")
local Sta = Library:AddTab("Status","6026568198")
local M = Library:AddTab("Main","6026568198")
local S = Library:AddTab("Setting","6026568198")
local Ri = Library:AddTab("Rip Indra","6026568198")
local I = Library:AddTab("Item","6026568198")
local Q = Library:AddTab("Quest","6026568198")
local V = Library:AddTab("Race V2-3","6026568198")
local Mi = Library:AddTab("Mirage Island","6026568198")
local VV = Library:AddTab("Race V4","6026568198")
local Se = Library:AddTab("Sea Event","6026568198")
local P = Library:AddTab("Player","6026568198")
local R = Library:AddTab("Raid","6026568198")
local F = Library:AddTab("Fruits","6026568198")
local T = Library:AddTab("Teleport","6026568198")
local St = Library:AddTab("Stats","6026568198")
local E = Library:AddTab("ESP","6026568198")
local Mis = Library:AddTab("Misc","6026568198")
local IDK = Library:AddTab("Don't Care","6026568198")

-- Discord Tab
D:AddLabel("Join Discord To Notification When Script Update")
D:AddLabel("Script Update")
-- Status Tab
Sta:AddLabel("Soon")
-- Main Tab
M:AddLabel("Farm")
...
M:AddToggle("Start Farm", _G.AutoFarm, function(value)
        _G.AutoFarm = value
...
M:AddLabel("Farm Boss")
M:AddLabel("Farm Chest")
M:AddToggle("Auto Farm Chest Tween", false, function(value)
 AutoFarmChest = value
...
M:AddToggle("Auto Farm Chest Bypass", false, function(vu)
	_G.ChestBypass = vu
end)
...
S:AddToggle("Bypass TP", false, function(Fast)
    BypassTP = Fast
end)

S:AddToggle("Auto Buso Haki", true, function(value)
_G.AUTOHAKI = value
end)
spawn(function()
    while wait(.1) do
...
-- Rip Indra Tab
Ri:AddLabel("Elite Hunter")
Ri:AddToggle("Auto Elite Hunter", _G.AutoElitehunter, function(value)
...
Ri:AddLabel("Haki Colors")
Ri:AddToggle("Auto Buy Haki Colors", _G.AutoBuyEnchancementColour, function(value)
        _G.AutoBuyEnchancementColour = value
    end)
    
Ri:AddToggle("Auto Buy Haki Colors [Hop]", _G.AutoBuyEnchancementColour_Hop, function(value)
...
-- Misc Tab
Mis:AddLabel("Misc")
Mis:AddButton("Open Devil Shop", function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("GetFruits")
        game:GetService("Players").LocalPlayer.PlayerGui.Main.FruitShop.Visible = true
    end)
    
Mis:AddButton("Open Title", function()
    local args = {
        [1] = "getTitles"
    }
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
...
Mis:AddButton("Open Haki Colors", function()
    game.Players.localPlayer.PlayerGui.Main.Colors.Visible = true
end)

Mis:AddLabel("Team")

Mis:AddButton("Join Pirates Team", function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SetTeam","Pirates") 
    end)
    
Mis:AddButton("Join Marines Team", function()
